  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      body: SingleChildScrollView(
        child: Container(
          margin: EdgeInsets.only(top:40.0,left: 20.0,right: 20.0,bottom: 50.0),
          child: Form(
             key: _formkey,
            child: Column(
              ...
              children: [
                ...
                Center(child: Text("Sign Up",style: Appwidget.semiboldTextStyle(),)),
                ...
                Center(
                  child:ElevatedButton(
                    ...
                    if(_formkey.currentState!.validate()){
                        ...
                        try{
                          ...
                          String avata= "https://ui-avatars.com/api/?name=${name}&background=random";
                          await Share_pref().saveUserId(uid);
                          await Share_pref().saveUserName(namecontroller.text);
                          await Share_pref().saveUserEmail(emailcontroller.text);
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            ...
                            content: Text("đăng ký thành công! ",style: TextStyle(fontSize: 15.0),),));
                  ...
                  Text("Đăng ký", style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),
                  ),
                  ),
                ),
                SizedBox(height: 20.0,),
                ...
                Row(
                  ...
                  children: [
                    Text("Bạn đã có tài khoản rồi?",style: Appwidget.lightTextStyle(),),
                    GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>Login()));
                        },
                        child: Text("Đăng nhập ",style: TextStyle(color: Colors.green,fontWeight: FontWeight.w500,fontSize: 18.0),)),
                  ],
                ),
